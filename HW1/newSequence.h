...
public:
	...
	Sequence(int userMax); //creates an empty sequnce with a max speicfied by the user

	~Sequence(); //destructor to delete dynamic array
...
private:
	...
	int m_size; //size of the sequence-array
	ItemType *m_array;
	int maxItems;
